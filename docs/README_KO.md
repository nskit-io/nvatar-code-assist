...
> **안내:** NVatar 서버는 `https://nvatar.nskit.io`에서 호스팅됩니다. 로컬 셀프호스팅은 지원되지 않습니다. 자체 인프라에 NVatar를 도입하려면 [문의해 주세요](mailto:nskit@neoulsoft.com).
...
- 전용 리소스가 필요한 기업 도입은 [문의해 주세요](mailto:nskit@neoulsoft.com).
